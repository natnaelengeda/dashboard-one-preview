                ...
                data.map((items) => (
                  <tr key={items.name}>
                    <td className="border-b border-blue-gray-50 py-3 px-5">
                      <div className="flex items-center gap-4">
                        <Typography variant="medium">{items.item}</Typography>
                      </div>
                    </td>
                    <td className="border-b border-blue-gray-50 py-3 px-5">
                      <Typography variant="medium">{items.amount}</Typography>
                    </td>
                  </tr>
                ))}
            </tbody>
              ...
              {table &&
                table.map((items) => (
                  <tr key={items.id}>
                    <td className="border-b border-blue-gray-50 py-3 px-5">
                      <div className="flex items-center gap-4">
                        <Typography variant="medium">{items.name}</Typography>
                      </div>
                    </td>
                    <td className="border-b border-blue-gray-50 py-3 px-5">
                      <div className="flex items-center gap-4">
                          ...
                          <Select>
                            {items.item.map((item) => (
                              <Option key={item.id} value={item.id}>
                                {item.level} - {item.name} - {item.label}
                              </Option>
                            ))}
                          </Select>
                        </Typography>
